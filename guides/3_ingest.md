...
Windows:
```bash
$body = '{"text": "Test document via API", "metadata": {"source": "api_test"}}'
Invoke-RestMethod -Method Post -Uri "https://ewf2dj6939.execute-api.eu-west-1.amazonaws.com/prod/ingest" -Headers @{"x-api-key"="bQl41yjR6h3z1xX89Dhp4ywdUUPoKgCaTpyDlFfb"} -ContentType "application/json" -Body $body
```
You should see:
```json
