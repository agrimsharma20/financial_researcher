...
variable "bedrock_model_id" {
  description = "Bedrock model ID for complex agents (reporter, retirement)"
  type        = string
}

variable "bedrock_lite_model_id" {
  description = "Bedrock lite model ID for simple agents (tagger, charter, planner). Falls back to bedrock_model_id if not set."
  type        = string
  default     = ""
}
